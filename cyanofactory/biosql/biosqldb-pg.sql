...
CREATE SEQUENCE taxon_name_pk_seq;
CREATE TABLE taxon_name ( 
	 fake_id INTEGER DEFAULT nextval ( 'taxon_name_pk_seq' ) NOT NULL , 
...
CREATE SEQUENCE term_synonym_pk_seq;
CREATE TABLE term_synonym (
	 fake_id INTEGER DEFAULT nextval ( 'term_synonym_pk_seq' ) NOT NULL , 
...
CREATE SEQUENCE term_dbxref_pk_seq;
CREATE TABLE term_dbxref ( 
	 fake_id INTEGER DEFAULT nextval ( 'term_dbxref_pk_seq' ) NOT NULL , 
	 term_id INTEGER NOT NULL , 
...
-- closure table too 
CREATE SEQUENCE bioentry_path_pk_seq;
CREATE TABLE bioentry_path ( 
	 fake_id INTEGER DEFAULT nextval ( 'bioentry_path_pk_seq' ) NOT NULL , 
	 object_bioentry_id INTEGER NOT NULL , 
	 subject_bioentry_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
	 distance INTEGER,
...
CREATE TABLE dbxref_qualifier_value ( 
	 fake_id INTEGER DEFAULT nextval ( 'dbxref_qualifier_value_pk_seq' ) NOT NULL , 
	 dbxref_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
...
CREATE SEQUENCE bioentry_dbxref_pk_seq;
CREATE TABLE bioentry_dbxref ( 
	 fake_id INTEGER DEFAULT nextval ( 'bioentry_dbxref_pk_seq' ) NOT NULL , 
	 bioentry_id INTEGER NOT NULL , 
	 dbxref_id INTEGER NOT NULL , 
	 rank INTEGER , 
	 PRIMARY KEY ( fake_id ) ,
...
CREATE SEQUENCE bioentry_reference_pk_seq;
CREATE TABLE bioentry_reference ( 
	 fake_id INTEGER DEFAULT nextval ( 'bioentry_reference_pk_seq' ) NOT NULL , 
	 bioentry_id INTEGER NOT NULL , 
	 ...
	 rank INTEGER NOT NULL DEFAULT 0 , 
	 PRIMARY KEY ( fake_id ) ,
	 UNIQUE ( bioentry_id , reference_id , rank ) ) ; 
...
CREATE SEQUENCE bioentry_qualifier_value_pk_seq;
CREATE TABLE bioentry_qualifier_value ( 
	 fake_id INTEGER DEFAULT nextval ( 'bioentry_qualifier_value_pk_seq' ) NOT NULL , 
	 bioentry_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
	 value TEXT , 
	 rank INTEGER NOT NULL DEFAULT 0 , 
...
-- closure table too 
CREATE SEQUENCE seqfeature_path_pk_seq;
CREATE TABLE seqfeature_path ( 
	 fake_id INTEGER DEFAULT nextval ( 'seqfeature_path_pk_seq' ) NOT NULL , 
	 object_seqfeature_id INTEGER NOT NULL , 
	 subject_seqfeature_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
	 distance INTEGER,
...
CREATE SEQUENCE seqfeature_qualifier_value_pk_seq;
CREATE TABLE seqfeature_qualifier_value ( 
	 fake_id INTEGER DEFAULT nextval ( 'seqfeature_qualifier_value_pk_seq' ) NOT NULL , 
	 seqfeature_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
	 rank INTEGER NOT NULL DEFAULT 0 , 
	 value TEXT NOT NULL , 
	 PRIMARY KEY ( fake_id ) ,
	 UNIQUE ( seqfeature_id , term_id , rank ) ) ; 
...
CREATE SEQUENCE seqfeature_dbxref_pk_seq; 
CREATE TABLE seqfeature_dbxref ( 
	 fake_id INTEGER DEFAULT nextval ( 'seqfeature_dbxref_pk_seq' ) NOT NULL , 
	 seqfeature_id INTEGER NOT NULL , 
	 dbxref_id INTEGER NOT NULL , 
	 rank INTEGER , 
	 PRIMARY KEY ( fake_id ) ,
	 UNIQUE ( seqfeature_id , dbxref_id ) ) ; 
...
CREATE SEQUENCE location_qualifier_value_pk_seq;
CREATE TABLE location_qualifier_value ( 
	 fake_id INTEGER DEFAULT nextval ( 'location_qualifier_value_pk_seq' ) NOT NULL , 
	 location_id INTEGER NOT NULL , 
	 term_id INTEGER NOT NULL , 
	 value VARCHAR ( 255 ) NOT NULL , 
	 int_value INTEGER , 
	 PRIMARY KEY ( fake_id ) ,
	 UNIQUE ( location_id , term_id ) ) ; 
