...
urlpatterns += cyano_pattern("sbgn/", views.sbgn, root=True)
...
urlpatterns += cyano_pattern("basket/", views.basket, name="cyano-basket", root=True, species=True)
urlpatterns += cyano_pattern(r'basket/(?P<basket_id>[0-9]+)/', views.basket, name="cyano-basket", root=True, species=True)
urlpatterns += cyano_pattern('basket/create/', views.basket_create, name="cyano-basket-create-save-form", root=True)
urlpatterns += cyano_pattern(r'basket/rename/(?P<basket_id>[0-9]+)/', views.basket_rename, name="cyano-basket-rename-save-form", root=True)
urlpatterns += cyano_pattern('basket/op/', views.basket_op, name="cyano-basket-op", root=True, species=True)
...
urlpatterns += cyano_pattern(r"user/(?P<username>[\w\d]+)/", views.user, root=True, species=True)
urlpatterns += cyano_pattern("user/", views.users, root=True, species=True)
urlpatterns += cyano_pattern("tutorial/", views.tutorial, root=True, species=True)
urlpatterns += cyano_pattern("jobs/", views.jobs, root=True, species=True)
urlpatterns += cyano_pattern("search/", views.search, root=True, species=True)
urlpatterns += cyano_pattern("add/", views.add, model_type=True)
urlpatterns += cyano_pattern("delete/", views.delete, species=True, item=True)
urlpatterns += cyano_pattern("edit/", views.edit, species=True, item=True)
urlpatterns += cyano_pattern("export/", views.exportData, species=True)
urlpatterns += cyano_pattern("import/data/", views.importData, species=True)
urlpatterns += cyano_pattern("import/species/", views.importSpeciesData, root=True)
urlpatterns += cyano_pattern("permission/", views.global_permission, root=True)
urlpatterns += cyano_pattern("history/(?P<detail_id>[0-9]+)/", views.history_detail, item=True)
urlpatterns += cyano_pattern("history/", views.history, species=True, model_type=True, item=True)
urlpatterns += cyano_pattern("permission/edit/", views.permission_edit, species=True, item=True)
urlpatterns += cyano_pattern("permission/", views.permission, species=True, item=True)
