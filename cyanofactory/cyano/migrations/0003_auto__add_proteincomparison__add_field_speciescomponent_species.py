...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProteinComparison'
        db.create_table(u'cyano_proteincomparison', (
            ('wid', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('protein_a', self.gf('django.db.models.fields.IntegerField')()),
            ('protein_b', self.gf('django.db.models.fields.IntegerField')()),
            ('equal_score', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'cyano', ['ProteinComparison'])

        # Adding field 'SpeciesComponent.species'
        db.add_column(u'cyano_speciescomponent', 'species',
                      self.gf('cyano.history.HistoryForeignKey')(default=1, related_name=u'components', to=orm['cyano.Species']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'ProteinComparison'
        db.delete_table(u'cyano_proteincomparison')

        # Deleting field 'SpeciesComponent.species'
        db.delete_column(u'cyano_speciescomponent', 'species_id')
