...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ChromosomeFeature.direction'
        db.delete_column(u'cyano_chromosomefeature', 'direction')

        # Deleting field 'ChromosomeFeature.length'
        db.delete_column(u'cyano_chromosomefeature', 'length')

        # Deleting field 'ChromosomeFeature.coordinate'
        db.delete_column(u'cyano_chromosomefeature', 'coordinate')

        # Deleting field 'ChromosomeFeature.chromosome'
        db.delete_column(u'cyano_chromosomefeature', 'chromosome_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ChromosomeFeature.direction'
        db.add_column(u'cyano_chromosomefeature', 'direction',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'ChromosomeFeature.length'
        db.add_column(u'cyano_chromosomefeature', 'length',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ChromosomeFeature.coordinate'
        db.add_column(u'cyano_chromosomefeature', 'coordinate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ChromosomeFeature.chromosome'
        db.add_column(u'cyano_chromosomefeature', 'chromosome',
                      self.gf('cyano.history.HistoryForeignKey')(default=0, related_name=u'features', to=orm['cyano.Genome']),
                      keep_default=False)
