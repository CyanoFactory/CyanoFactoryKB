...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cyano_revision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('cyano.history.HistoryForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('detail', self.gf('cyano.history.HistoryForeignKey')(related_name=u'revisions', to=orm['cyano.RevisionDetail'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('new_data', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        ...
        db.create_table(u'cyano_evidence', (
            ...
            ('is_experimentally_constrained', self.gf('django.db.models.fields.BooleanField')()),
        ...
        # Adding model 'EntryBasicTextData'
        db.create_table(u'cyano_entrybasictextdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.TextField')(default=u'')),
        ))
        db.send_create_signal(u'cyano', ['EntryBasicTextData'])
        ...
        db.create_table(u'cyano_mediacomposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concentration', self.gf('django.db.models.fields.FloatField')()),
            ('is_diffused', self.gf('django.db.models.fields.BooleanField')()),
        ))
        ...
        db.create_table(u'cyano_speciescomponent', (
            ...
            ('parent', self.gf('cyano.history.HistoryForeignKey')(blank=True, related_name=u'children', null=True, on_delete=models.SET_NULL, to=orm['cyano.SpeciesComponent'])),
        ))
        ...
        # Adding model 'Genome'
        db.create_table(u'cyano_genome', (
            ('parent_ptr_molecule', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_genome', unique=True, primary_key=True, to=orm['cyano.Molecule'])),
            ('sequence', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'cyano', ['Genome'])

        # Adding model 'Chromosome'
        db.create_table(u'cyano_chromosome', (
            ('parent_ptr_genome', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_chromosome', unique=True, primary_key=True, to=orm['cyano.Genome'])),
        ))
        db.send_create_signal(u'cyano', ['Chromosome'])

        # Adding model 'Plasmid'
        db.create_table(u'cyano_plasmid', (
            ('parent_ptr_genome', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_plasmid', unique=True, primary_key=True, to=orm['cyano.Genome'])),
        ))
        ...
        # Adding model 'FeaturePosition'
        db.create_table(u'cyano_featureposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chromosome_feature', self.gf('cyano.history.HistoryForeignKey')(related_name=u'positions', to=orm['cyano.ChromosomeFeature'])),
            ('chromosome', self.gf('cyano.history.HistoryForeignKey')(related_name=u'features', to=orm['cyano.Genome'])),
            ('coordinate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('direction', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'cyano', ['FeaturePosition'])
        ...
        db.create_table(u'cyano_gene', (
            ...
            ('chromosome', self.gf('cyano.history.HistoryForeignKey')(related_name=u'genes', to=orm['cyano.Genome'])),
            ('coordinate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('direction', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ...
        db.create_table(u'cyano_metabolite', (
            ...
            ('is_hydrophobic', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.create_table(u'cyano_reaction', (
            ...
            ('is_spontaneous', self.gf('django.db.models.fields.BooleanField')()),
        ...
        # Adding unique constraint on 'CrossReference', fields ['xid', 'source']
        db.create_unique(u'cyano_crossreference', ['xid', 'source'])
        ...
        # Adding model 'MassSpectrometryJob'
        db.create_table(u'cyano_massspectrometryjob', (
            ('parent_ptr_species_component', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_mass_spectrometry', unique=True, primary_key=True, to=orm['cyano.SpeciesComponent'])),
        ))
        db.send_create_signal(u'cyano', ['MassSpectrometryJob'])

        # Adding model 'Peptide'
        db.create_table(u'cyano_peptide', (
            (u'protein_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cyano.Protein'], unique=True, primary_key=True)),
            ('parent_ptr_species_component', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_peptide', unique=True, to=orm['cyano.SpeciesComponent'])),
            ('sequence', self.gf('django.db.models.fields.TextField')(default=u'', blank=True)),
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('proteotypic', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('charge', self.gf('django.db.models.fields.IntegerField')()),
            ('mass', self.gf('django.db.models.fields.FloatField')()),
            ('zscore', self.gf('django.db.models.fields.FloatField')()),
            ('retention_time', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'cyano', ['Peptide'])

        # Adding M2M table for field proteins on 'Peptide'
        m2m_table_name = db.shorten_name(u'cyano_peptide_proteins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('peptide', models.ForeignKey(orm[u'cyano.peptide'], null=False)),
            ('entrybasictextdata', models.ForeignKey(orm[u'cyano.entrybasictextdata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['peptide_id', 'entrybasictextdata_id'])

        # Adding model 'MassSpectrometryProtein'
        db.create_table(u'cyano_massspectrometryprotein', (
            (u'protein_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cyano.Protein'], unique=True, primary_key=True)),
            ('parent_ptr_species_component', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'child_ptr_ms_protein', unique=True, to=orm['cyano.SpeciesComponent'])),
            ...
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('pi', self.gf('django.db.models.fields.FloatField')()),
            ('mass', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'cyano', ['MassSpectrometryProtein'])

        # Adding M2M table for field ambiguous on 'MassSpectrometryProtein'
        m2m_table_name = db.shorten_name(u'cyano_massspectrometryprotein_ambiguous')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('massspectrometryprotein', models.ForeignKey(orm[u'cyano.massspectrometryprotein'], null=False)),
            ('entrybasictextdata', models.ForeignKey(orm[u'cyano.entrybasictextdata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['massspectrometryprotein_id', 'entrybasictextdata_id'])

        # Adding M2M table for field sub on 'MassSpectrometryProtein'
        m2m_table_name = db.shorten_name(u'cyano_massspectrometryprotein_sub')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('massspectrometryprotein', models.ForeignKey(orm[u'cyano.massspectrometryprotein'], null=False)),
            ('entrybasictextdata', models.ForeignKey(orm[u'cyano.entrybasictextdata'], null=False))
        ...
        # Adding model 'MassSpectrometryProteinDetail'
        db.create_table(u'cyano_massspectrometryproteindetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('protein', self.gf('cyano.history.HistoryForeignKey')(related_name=u'protein_details', to=orm['cyano.MassSpectrometryProtein'])),
            ('sequence', self.gf('django.db.models.fields.TextField')()),
            ('sequence_ptm', self.gf('django.db.models.fields.TextField')()),
            ('coordinate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('length', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('proteotypic', self.gf('django.db.models.fields.BooleanField')()),
            ('zscore', self.gf('django.db.models.fields.FloatField')()),
            ('delta_mass', self.gf('django.db.models.fields.FloatField')()),
            ('mass', self.gf('django.db.models.fields.FloatField')()),
            ('charge', self.gf('django.db.models.fields.IntegerField')()),
            ('retention_time', self.gf('django.db.models.fields.IntegerField')()),
            ('theoretical_mass', self.gf('django.db.models.fields.FloatField')()),
            ('missed_cleavages', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'cyano', ['MassSpectrometryProteinDetail'])


    def backwards(self, orm):
        # Removing unique constraint on 'CrossReference', fields ['xid', 'source']
        db.delete_unique(u'cyano_crossreference', ['xid', 'source'])
        ...
        # Deleting model 'EntryBasicTextData'
        db.delete_table(u'cyano_entrybasictextdata')
        ...
        db.delete_table(u'cyano_genome')
        ...
        # Deleting model 'FeaturePosition'
        db.delete_table(u'cyano_featureposition')
        ...
        # Deleting model 'MassSpectrometryJob'
        db.delete_table(u'cyano_massspectrometryjob')

        # Deleting model 'Peptide'
        db.delete_table(u'cyano_peptide')

        # Removing M2M table for field proteins on 'Peptide'
        db.delete_table(db.shorten_name(u'cyano_peptide_proteins'))

        # Deleting model 'MassSpectrometryProtein'
        db.delete_table(u'cyano_massspectrometryprotein')

        # Removing M2M table for field ambiguous on 'MassSpectrometryProtein'
        db.delete_table(db.shorten_name(u'cyano_massspectrometryprotein_ambiguous'))

        # Removing M2M table for field sub on 'MassSpectrometryProtein'
        db.delete_table(db.shorten_name(u'cyano_massspectrometryprotein_sub'))

        # Deleting model 'MassSpectrometryProteinDetail'
        db.delete_table(u'cyano_massspectrometryproteindetail')
