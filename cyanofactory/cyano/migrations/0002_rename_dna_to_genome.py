...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table(u'cyano_dna', u'cyano_genome')                                                                                                                   
        db.send_create_signal('cyano', ['Genome'])
        
        db.rename_column('cyano_chromosome', 'parent_ptr_dna_id', 'parent_ptr_genome_id')
        db.rename_column('cyano_plasmid', 'parent_ptr_dna_id', 'parent_ptr_genome_id')

    def backwards(self, orm):
        # Adding model 'Permission'
        db.rename_table(u'cyano_genome', u'cyano_dna')                                                                                                                   
        db.send_create_signal('cyano', ['DNA'])
        
        db.rename_column('cyano_chromosome', 'parent_ptr_genome_id', 'parent_ptr_dna_id')
        db.rename_column('cyano_plasmid', 'parent_ptr_genome_id', 'parent_ptr_dna_id')
