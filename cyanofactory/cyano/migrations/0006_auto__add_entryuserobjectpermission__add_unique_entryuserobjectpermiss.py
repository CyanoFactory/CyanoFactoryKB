...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntryUserObjectPermission'
        db.create_table(u'cyano_entryuserobjectpermission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Permission'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyano.Entry'])),
        ))
        db.send_create_signal(u'cyano', ['EntryUserObjectPermission'])

        # Adding unique constraint on 'EntryUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.create_unique(u'cyano_entryuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Adding model 'EntryGroupObjectPermission'
        db.create_table(u'cyano_entrygroupobjectpermission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Permission'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyano.Entry'])),
        ))
        db.send_create_signal(u'cyano', ['EntryGroupObjectPermission'])

        # Adding unique constraint on 'EntryGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.create_unique(u'cyano_entrygroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.delete_unique(u'cyano_entrygroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Removing unique constraint on 'EntryUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.delete_unique(u'cyano_entryuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Deleting model 'EntryUserObjectPermission'
        db.delete_table(u'cyano_entryuserobjectpermission')

        # Deleting model 'EntryGroupObjectPermission'
        db.delete_table(u'cyano_entrygroupobjectpermission')
    ...
    models = {
        ...
        u'cyano.entrygroupobjectpermission': {
            'Meta': {'unique_together': "([u'group', u'permission', u'content_object'],)", 'object_name': 'EntryGroupObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cyano.Entry']"}),
        ...
        u'cyano.entryuserobjectpermission': {
            'Meta': {'unique_together': "([u'user', u'permission', u'content_object'],)", 'object_name': 'EntryUserObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cyano.Entry']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Permission']"}),
        ...
        u'cyano.proteincomparison': {
            'Meta': {'object_name': 'ProteinComparison'},
            'equal_score': ('django.db.models.fields.FloatField', [], {}),
            'protein_a': ('django.db.models.fields.IntegerField', [], {}),
            'protein_b': ('django.db.models.fields.IntegerField', [], {}),
            'wid': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'cyano.speciescomponent': {
            ...
            'species': ('cyano.history.HistoryForeignKey', [], {'related_name': "u'components'", 'to': u"orm['cyano.Species']"}),
