...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DesignTemplate'
        db.create_table(u'cyanodesign_designtemplate', (
        ...
        db.send_create_signal(u'cyanodesign', ['DesignTemplate'])


    def backwards(self, orm):
        # Deleting model 'DesignTemplate'
        db.delete_table(u'cyanodesign_designtemplate')
    ...
    models = {
        ...
        u'cyanodesign.designtemplate': {
            'Meta': {'object_name': 'DesignTemplate'},
