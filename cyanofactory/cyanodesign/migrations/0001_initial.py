...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DesignModel'
        db.create_table(u'cyanodesign_designmodel', (
        ...
        db.send_create_signal(u'cyanodesign', ['DesignModel'])


    def backwards(self, orm):
        # Deleting model 'DesignModel'
        db.delete_table(u'cyanodesign_designmodel')
