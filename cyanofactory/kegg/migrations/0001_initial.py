...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EcNumber'
        db.create_table(u'kegg_ecnumber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'kegg', ['EcNumber'])

        # Adding model 'Map'
        db.create_table(u'kegg_map', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('overview', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'kegg', ['Map'])

        # Adding M2M table for field ec_numbers on 'Map'
        m2m_table_name = db.shorten_name(u'kegg_map_ec_numbers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('map', models.ForeignKey(orm[u'kegg.map'], null=False)),
            ('ecnumber', models.ForeignKey(orm[u'kegg.ecnumber'], null=False))
        ))
        db.create_unique(m2m_table_name, ['map_id', 'ecnumber_id'])

        # Adding model 'Query'
        db.create_table(u'kegg_query', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'kegg', ['Query'])


    def backwards(self, orm):
        # Deleting model 'EcNumber'
        db.delete_table(u'kegg_ecnumber')

        # Deleting model 'Map'
        db.delete_table(u'kegg_map')

        # Removing M2M table for field ec_numbers on 'Map'
        db.delete_table(db.shorten_name(u'kegg_map_ec_numbers'))

        # Deleting model 'Query'
        db.delete_table(u'kegg_query')
