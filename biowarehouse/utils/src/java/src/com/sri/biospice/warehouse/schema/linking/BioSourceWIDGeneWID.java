/* $Id: BioSourceWIDGeneWID.java,v 1.1 2006/07/07 15:03:37 valerie Exp $ */
/* *******************************************************************
 ...
 *         Date: Sep 9, 2004
 */
public class BioSourceWIDGeneWID extends LinkingTable
{
    private static TableMetaData tableMetaData;


    public BioSourceWIDGeneWID( BioSource bioSource, Gene gene )
    {
        super( "BioSourceWID", "GeneWID" );
        this.setWID1( bioSource.getWID() );
        this.setWID2( gene.getWID() );
    }
