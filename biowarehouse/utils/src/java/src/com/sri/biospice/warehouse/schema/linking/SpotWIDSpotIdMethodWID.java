...
import com.sri.biospice.warehouse.schema.object.SpotIdMethod;

/**
 * @author Anish Kejariwal
 *         Date: Nov 1, 2006
 */
public class SpotWIDSpotIdMethodWID extends LinkingTable
{
    private static TableMetaData tableMetaData;


    public SpotWIDSpotIdMethodWID( Spot spot, SpotIdMethod spotIdMethod )
    {
        super( "SpotWID", "SpotIdMethodWID" );
        this.setWID1(spot.getWID() );
        this.setWID2(spotIdMethod.getWID() );
    }
