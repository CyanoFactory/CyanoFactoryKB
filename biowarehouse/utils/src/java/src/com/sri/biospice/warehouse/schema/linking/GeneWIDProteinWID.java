/* $Id: GeneWIDProteinWID.java,v 1.1 2006/07/07 15:03:37 valerie Exp $ */
/* *******************************************************************
 ...
 *         Date: Aug 13, 2004
 */
public class GeneWIDProteinWID extends LinkingTable
{
    private static TableMetaData tableMetaData;


    public GeneWIDProteinWID( Gene gene, Protein protein )
    {
        super( "GeneWID", "ProteinWID" );
