...
CREATE INDEX DATASETHIERARCHY_SuperWID ON DataSetHierarchy(SuperWID);
CREATE INDEX DATASETHIERARCHY_SubWID ON DataSetHierarchy(SubWID);
...
CREATE INDEX TranscriptionUnitComponent_OW ON TranscriptionUnitComponent(OtherWID);
...
CREATE INDEX BIOSOURCE_STRAIN ON BioSource(Strain);
