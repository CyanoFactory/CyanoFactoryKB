...
(
  Version  NUMBER(6,3)  NOT NULL,
  LoadDate  DATE  NOT NULL,
  MaxSpecialWID  NUMBER  NOT NULL,
  MaxReservedWID  NUMBER  NOT NULL,
...
--
CREATE SEQUENCE WID_sequence INCREMENT BY 1 START WITH 1000000 MINVALUE 1000000;

CREATE TABLE WIDTable
(
  PreviousWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_WIDTable PRIMARY KEY (PreviousWID) USING INDEX TABLESPACE INDEXES
);
...
--
CREATE SEQUENCE SpecialWID_sequence INCREMENT BY 1 START WITH 2 MINVALUE 2;

CREATE TABLE SpecialWIDTable
(
  PreviousWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_SpecialWIDTable PRIMARY KEY (PreviousWID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  QueryURL  VARCHAR2(255),
  LoadedBy  VARCHAR2(255),
  Application  VARCHAR2(255),
  ApplicationVersion  VARCHAR2(255),
  --
  CONSTRAINT PK_DataSet1 PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  SuperWID  NUMBER  NOT NULL,
  SubWID  NUMBER  NOT NULL
  --
);
...
(
  ...
  DatasetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Entry PRIMARY KEY (OtherWID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  BioAssayValuesWID  NUMBER  NOT NULL
  --
);
...
(
  ...
  ElementSymbol  VARCHAR2(2)  NOT NULL,
  AtomicWeight  NUMBER  NOT NULL,
  AtomicNumber  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Element PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Wavelength  NUMBER,
  Type  VARCHAR2(100),
  InstrumentWID  NUMBER,
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_LightSource1 PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX LightSource_DWID ON LightSource(DataSetWID) TABLESPACE INDEXES;
...
(
  WID  NUMBER  NOT NULL,
  BioSourceWID  NUMBER,
  FlowCytometryProbeWID  NUMBER,
  MeasurementWID  NUMBER,
  ManufacturerWID  NUMBER,
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_FlowCytometrySample1 PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX FlowCytometrySample_DWID ON FlowCytometrySample(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_FlowCytometryProbe1 PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX FlowCytometryProbe_DWID ON FlowCytometryProbe(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_TranscriptionUnit1 PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX TranscriptionUnit_DWID ON TranscriptionUnit(DataSetWID) TABLESPACE INDEXES;


CREATE TABLE TranscriptionUnitComponent
(
  Type  VARCHAR2(100)  NOT NULL,
  TranscriptionUnitWID  NUMBER  NOT NULL,
  OtherWID  NUMBER  NOT NULL
  --
);
...
(
  ...
  Name  VARCHAR2(255)  NOT NULL,
  Class  CHAR(1),
  BeilsteinName  VARCHAR2(50),
  SystematicName  VARCHAR2(255),
  CAS  VARCHAR2(50),
  Charge  NUMBER,
  EmpiricalFormula  VARCHAR2(50),
  MolecularWeightCalc  NUMBER,
  MolecularWeightExp  NUMBER,
  OctH2OPartitionCoeff  VARCHAR2(50),
  PKA1  NUMBER,
  PKA2  NUMBER,
  PKA3  NUMBER,
...
CREATE INDEX CHEMICAL_NAME ON Chemical(Name) TABLESPACE INDEXES;
...
(
  ...
  Name  VARCHAR2(250),
  DeltaG  VARCHAR2(50),
  ECNumber  VARCHAR2(50),
  ECNumberProposed  VARCHAR2(50),
  Spontaneous  CHAR(1),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Reaction PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX REACTION_DWID ON Reaction(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Interaction PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX INTERACTION_DWID ON Interaction(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Protein PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX PROTEIN_DWID ON Protein(DataSetWID) TABLESPACE INDEXES;


CREATE TABLE Feature
(
  WID  NUMBER  NOT NULL,
  Description  VARCHAR2(1300),
  Type  VARCHAR2(50),
  Class  VARCHAR2(50),
  SequenceType  CHAR(1)  NOT NULL,
  SequenceWID  NUMBER,
  Variant  CLOB,
  RegionOrPoint  VARCHAR2(10),
  PointType  VARCHAR2(10),
  StartPosition  NUMBER,
  EndPosition  NUMBER,
  StartPositionApproximate  VARCHAR2(10),
  EndPositionApproximate  VARCHAR2(10),
  ExperimentalSupport  CHAR(1),
  ComputationalSupport  CHAR(1),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Feature PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Function PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  ReactionWID  NUMBER  NOT NULL,
  ProteinWID  NUMBER  NOT NULL,
  ComplexWID  NUMBER,
  ReactionDirection  VARCHAR2(30),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_EnzymaticReaction PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX ER_DATASETWID ON EnzymaticReaction(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  NCBIID  VARCHAR2(2),
  Name  VARCHAR2(100),
  TranslationTable  VARCHAR2(64),
  StartCodon  VARCHAR2(64),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_GeneticCode PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Division PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Taxon PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  MAGEClass  VARCHAR2(100),
  TaxonWID  NUMBER,
  Name  VARCHAR2(200),
  Strain  VARCHAR2(220),
  Organ  VARCHAR2(50),
  Organelle  VARCHAR2(50),
  Tissue  VARCHAR2(100),
  CellType  VARCHAR2(50),
  CellLine  VARCHAR2(50),
  ATCCId  VARCHAR2(50),
  Diseased  CHAR(1),
  Disease  VARCHAR2(250),
  DevelopmentStage  VARCHAR2(50),
  Sex  VARCHAR2(15),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_BioSource PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_BioSubtype PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Class  VARCHAR2(30),
  Topology  VARCHAR2(30),
  Strandedness  VARCHAR2(30),
  SequenceDerivation  VARCHAR2(30),
  Fragment  CHAR(1),
  FullySequenced  CHAR(1),
  MoleculeLength  NUMBER,
  MoleculeLengthApproximate  VARCHAR2(10),
  CumulativeLength  NUMBER,
  CumulativeLengthApproximate  VARCHAR2(10),
  GeneticCodeWID  NUMBER,
  BioSourceWID  NUMBER,
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_NucleicAcid PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  NucleicAcidWID  NUMBER  NOT NULL,
  FullSequence  CHAR(1),
  Sequence  CLOB,
  Length  NUMBER,
  LengthApproximate  VARCHAR2(10),
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Subsequence PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  Name  VARCHAR2(255),
  NucleicAcidWID  NUMBER,
  SubsequenceWID  NUMBER,
  Type  VARCHAR2(100),
  GenomeID  VARCHAR2(35),
  CodingRegionStart  NUMBER,
  CodingRegionEnd  NUMBER,
  CodingRegionStartApproximate  VARCHAR2(10),
  CodingRegionEndApproximate  VARCHAR2(10),
  Direction  VARCHAR2(25),
  Interrupted  CHAR(1),
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Gene PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX GENE_DATASETWID ON Gene(DATASETWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Pathway PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX PATHWAY_BSWID_WID_DWID ON Pathway(BioSourceWID, WID, DataSetWID) TABLESPACE INDEXES;
CREATE INDEX PATHWAY_TYPE_WID_DWID ON Pathway(TYPE, WID, DataSetWID) TABLESPACE INDEXES;
CREATE INDEX PATHWAY_DWID ON Pathway(DataSetWID) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Term PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Computation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Citation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);

CREATE INDEX CITATION_PMID ON Citation(PMID) TABLESPACE INDEXES;
CREATE INDEX CITATION_CITATION ON Citation(Citation) TABLESPACE INDEXES;
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_ARCHIVE PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  GroupSize  NUMBER  NOT NULL,
  GroupIndex  NUMBER,
  TimePoint  NUMBER,
  TimeUnit  VARCHAR2(20),
  DataSetWID  NUMBER  NOT NULL,
  BioSourceWID  NUMBER,
  --
  CONSTRAINT PK_Experiment PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_ExpData PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  OtherWID  NUMBER  NOT NULL,
  Type  VARCHAR2(100),
  EvidenceType  VARCHAR2(100),
  Confidence  NUMBER,
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT CK_Support CHECK (Confidence > 0 AND Confidence <= 1),
  CONSTRAINT PK_Support PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ChemicalWID  NUMBER  NOT NULL,
  AtomIndex  NUMBER  NOT NULL,
  Atom  VARCHAR2(2)  NOT NULL,
...
(
  ChemicalWID  NUMBER  NOT NULL,
  Atom1Index  NUMBER  NOT NULL,
  Atom2Index  NUMBER  NOT NULL,
  BondType  NUMBER  NOT NULL,
  BondStereo  NUMBER
  --
);
...
(
  EnzymaticReactionWID  NUMBER  NOT NULL,
  ChemicalWID  NUMBER  NOT NULL,
  Prosthetic  CHAR(1)
  --
);
...
(
  EnzymaticReactionWID  NUMBER  NOT NULL,
  PrimaryWID  NUMBER  NOT NULL,
  AlternativeWID  NUMBER  NOT NULL,
  Cofactor  CHAR(1)
  --
);
...
(
  Pathway1WID  NUMBER  NOT NULL,
  Pathway2WID  NUMBER  NOT NULL,
  ChemicalWID  NUMBER  NOT NULL
  --
);
...
(
  PathwayWID  NUMBER  NOT NULL,
  ReactionWID  NUMBER  NOT NULL,
  PriorReactionWID  NUMBER,
  Hypothetical  CHAR(1)  NOT NULL
  --
);

CREATE INDEX PR_PATHWID_REACTIONWID ON PathwayReaction(PathwayWID, ReactionWID) TABLESPACE INDEXES;
...
(
  InteractionWID  NUMBER  NOT NULL,
  OtherWID  NUMBER  NOT NULL,
  Coefficient  NUMBER
  --
);

CREATE INDEX PR_INTERACTIONWID_OTHERWID ON InteractionParticipant(InteractionWID, OtherWID) TABLESPACE INDEXES;


CREATE TABLE SequenceMatch
(
  QueryWID  NUMBER  NOT NULL,
  MatchWID  NUMBER  NOT NULL,
  ComputationWID  NUMBER  NOT NULL,
  EValue  NUMBER,
  PValue  NUMBER,
...
(
  ComplexWID  NUMBER  NOT NULL,
  SubunitWID  NUMBER  NOT NULL,
  Coefficient  NUMBER
  --
);
...
(
  SubPathwayWID  NUMBER  NOT NULL,
  SuperPathwayWID  NUMBER  NOT NULL
  --
);
...
(
  TermWID  NUMBER  NOT NULL,
  RelatedTermWID  NUMBER  NOT NULL,
...
(
  OtherWID  NUMBER  NOT NULL,
  XID  VARCHAR2(150)  NOT NULL,
  Type  VARCHAR2(20),
  Version  VARCHAR2(10)
  --
);

CREATE INDEX DBID_XID_OTHERWID ON DBID(XID, OTHERWID) TABLESPACE INDEXES;
CREATE INDEX DBID_OTHERWID ON DBID(OTHERWID) TABLESPACE INDEXES;
...
(
  OtherWID  NUMBER  NOT NULL,
  Syn  VARCHAR2(255)  NOT NULL
  --
);

CREATE INDEX SYNONYM_OTHERWID_SYN ON SynonymTable(OTHERWID, SYN) TABLESPACE INDEXES;
...
(
  BioSourceWID  NUMBER  NOT NULL,
  BioSubtypeWID  NUMBER  NOT NULL
  --
);
...
(
  ExperimentWID  NUMBER  NOT NULL,
  RelatedExperimentWID  NUMBER  NOT NULL
  --
);
...
(
  ...
  DatasetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_GelLocation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  SpotId  VARCHAR2(25),
  MolecularWeightEst  NUMBER,
  PIEst  VARCHAR2(50),
  DatasetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_Spot PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  MethodDesc  VARCHAR2(500),
  MethodAbbrev  VARCHAR2(10),
  DatasetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_SpotIdMethod PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  SpotWID  NUMBER  NOT NULL,
  SpotIdMethodWID  NUMBER  NOT NULL
  --
);
...
(
  ...
  Value  VARCHAR2(255),
  Type_  VARCHAR2(255),
  NameValueType_PropertySets  NUMBER,
  OtherWID  NUMBER,
  --
  CONSTRAINT PK_NameValueType PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  MAGEClass  VARCHAR2(100)  NOT NULL,
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  URI  VARCHAR2(255),
  Address  VARCHAR2(255),
  Phone  VARCHAR2(255),
  TollFreePhone  VARCHAR2(255),
  Email  VARCHAR2(255),
  Fax  VARCHAR2(255),
  Parent  NUMBER,
  LastName  VARCHAR2(255),
  FirstName  VARCHAR2(255),
  MidInitials  VARCHAR2(255),
  Affiliation  NUMBER,
  --
  CONSTRAINT PK_Contact PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  SurfaceType  NUMBER,
  --
  CONSTRAINT PK_ArrayDesign PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  ArrayDesign_FeatureGroups  NUMBER,
  DesignElementGroup_Species  NUMBER,
  FeatureWidth  NUMBER,
  FeatureLength  NUMBER,
  FeatureHeight  NUMBER,
  FeatureGroup_TechnologyType  NUMBER,
  FeatureGroup_FeatureShape  NUMBER,
  FeatureGroup_DistanceUnit  NUMBER,
  --
  CONSTRAINT PK_DesignElementGroup PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  LowerRightX  NUMBER,
  LowerRightY  NUMBER,
  Zone_DistanceUnit  NUMBER,
  ZoneGroup_ZoneLocations  NUMBER,
  --
  CONSTRAINT PK_Zone PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  PhysicalArrayDesign_ZoneGroups  NUMBER,
  SpacingsBetweenZonesX  NUMBER,
  SpacingsBetweenZonesY  NUMBER,
  ZonesPerX  NUMBER,
  ZonesPerY  NUMBER,
  ZoneGroup_DistanceUnit  NUMBER,
  ZoneGroup_ZoneLayout  NUMBER,
  --
  CONSTRAINT PK_ZoneGroup PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  NumFeaturesPerRow  NUMBER,
  NumFeaturesPerCol  NUMBER,
  SpacingBetweenRows  NUMBER,
  SpacingBetweenCols  NUMBER,
  ZoneLayout_DistanceUnit  NUMBER,
  --
  CONSTRAINT PK_ZoneLayout PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  Experiment_ExperimentDesigns  NUMBER,
  QualityControlDescription  NUMBER,
  NormalizationDescription  NUMBER,
  ReplicateDescription  NUMBER,
  --
  CONSTRAINT PK_ExperimentDesign PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  ExperimentalFactor_Category  NUMBER,
  --
  CONSTRAINT PK_ExperimentalFactor PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  ExperimentalFactor2  NUMBER,
  FactorValue_Measurement  NUMBER,
  FactorValue_Value  NUMBER,
  --
  CONSTRAINT PK_FactorValue PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  IsBackground  CHAR(1),
  Channel  NUMBER,
  QuantitationType_Scale  NUMBER,
  QuantitationType_DataType  NUMBER,
  TargetQuantitationType  NUMBER,
  --
  CONSTRAINT PK_QuantitationType PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  URI  VARCHAR2(255),
  --
  CONSTRAINT PK_Database_ PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  ArrayIdentifier  VARCHAR2(255),
  ArrayXOrigin  NUMBER,
  ArrayYOrigin  NUMBER,
  OriginRelativeTo  VARCHAR2(255),
  ArrayDesign  NUMBER,
  Information  NUMBER,
  ArrayGroup  NUMBER,
  --
  CONSTRAINT PK_Array_ PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  NumArrays  NUMBER,
  OrientationMark  VARCHAR2(255),
  OrientationMarkPosition  VARCHAR2(25),
  Width  NUMBER,
  Length  NUMBER,
  ArrayGroup_SubstrateType  NUMBER,
  ArrayGroup_DistanceUnit  NUMBER,
  --
  CONSTRAINT PK_ArrayGroup PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  ManufacturingDate  VARCHAR2(255),
  Tolerance  NUMBER,
  --
  CONSTRAINT PK_ArrayManufacture PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Array_  NUMBER,
  --
  CONSTRAINT PK_ArrayManufactureDeviation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  ArrayManufactureDeviation  NUMBER,
  FeatureDefect_DefectType  NUMBER,
  FeatureDefect_PositionDelta  NUMBER,
  Feature  NUMBER,
  --
  CONSTRAINT PK_FeatureDefect PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  ArrayGroup_Fiducials  NUMBER,
  Fiducial_FiducialType  NUMBER,
  Fiducial_DistanceUnit  NUMBER,
  Fiducial_Position  NUMBER,
  --
  CONSTRAINT PK_Fiducial PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  MAGEClass  VARCHAR2(100)  NOT NULL,
  ArrayManufacture_FeatureLIMSs  NUMBER,
  Quality  VARCHAR2(255),
  Feature  NUMBER,
  BioMaterial  NUMBER,
  ManufactureLIMS_IdentifierLIMS  NUMBER,
  BioMaterialPlateIdentifier  VARCHAR2(255),
  BioMaterialPlateRow  VARCHAR2(255),
  BioMaterialPlateCol  VARCHAR2(255),
  --
  CONSTRAINT PK_ManufactureLIMS PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DeltaX  NUMBER,
  DeltaY  NUMBER,
  PositionDelta_DistanceUnit  NUMBER,
  --
  CONSTRAINT PK_PositionDelta PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  ArrayManufactureDeviation  NUMBER,
  ZoneDefect_DefectType  NUMBER,
  ZoneDefect_PositionDelta  NUMBER,
  Zone  NUMBER,
  --
  CONSTRAINT PK_ZoneDefect PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  SeqFeature_Regions  NUMBER,
  StrandType  VARCHAR2(255),
  SeqFeatureLocation_Subregions  NUMBER,
  SeqFeatureLocation_Coordinate  NUMBER,
  --
  CONSTRAINT PK_SeqFeatureLocation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Start_  NUMBER,
  End  NUMBER,
  CompositeCompositeMap  NUMBER,
  Composite  NUMBER,
  ReporterCompositeMap  NUMBER,
  Reporter  NUMBER,
  --
  CONSTRAINT PK_SequencePosition PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  FeatureGroup_Features  NUMBER,
  DesignElement_ControlType  NUMBER,
  Feature_Position  NUMBER,
  Zone  NUMBER,
  Feature_FeatureLocation  NUMBER,
  FeatureGroup  NUMBER,
  Reporter_WarningType  NUMBER,
  --
  CONSTRAINT PK_DesignElement PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  Feature  NUMBER,
  FeatureReporterMap  NUMBER,
  --
  CONSTRAINT PK_FeatureInformation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Column_  NUMBER,
  --
  CONSTRAINT PK_FeatureLocation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  CompositePosition  NUMBER,
  FeatureInformation  NUMBER,
  StartCoord  NUMBER,
  NewSequence  VARCHAR2(255),
  ReplacedLength  NUMBER,
  ReporterPosition  NUMBER,
  --
  CONSTRAINT PK_MismatchInformation PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  X  NUMBER,
  Y  NUMBER,
  Position_DistanceUnit  NUMBER,
  --
  CONSTRAINT PK_Position_ PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  CompositeSequence  NUMBER,
  Reporter  NUMBER,
  CompositeSequence2  NUMBER,
  BioAssayMapTarget  NUMBER,
  TargetQuantitationType  NUMBER,
  DerivedBioAssayDataTarget  NUMBER,
  QuantitationTypeMapping  NUMBER,
  DesignElementMapping  NUMBER,
  Transformation_BioAssayMapping  NUMBER,
  BioMaterial_Treatments  NUMBER,
  Order_  NUMBER,
  Treatment_Action  NUMBER,
  Treatment_ActionMeasurement  NUMBER,
  Array_  NUMBER,
  PhysicalBioAssayTarget  NUMBER,
  PhysicalBioAssay  NUMBER,
  Target  NUMBER,
  PhysicalBioAssaySource  NUMBER,
  MeasuredBioAssayTarget  NUMBER,
  PhysicalBioAssay2  NUMBER,
  --
  CONSTRAINT PK_BioEvent PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  BioAssayDimension  NUMBER,
  DesignElementDimension  NUMBER,
  QuantitationTypeDimension  NUMBER,
  BioAssayData_BioDataValues  NUMBER,
  ProducerTransformation  NUMBER,
  --
  CONSTRAINT PK_BioAssayData PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Name  VARCHAR2(255),
  --
  CONSTRAINT PK_BioAssayDimension PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_BioAssayMapping PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  BioAssay  NUMBER,
  BioDataTuples_BioAssayTuples  NUMBER,
  --
  CONSTRAINT PK_BioAssayTuple PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  MAGEClass  VARCHAR2(100)  NOT NULL,
  Order_  VARCHAR2(25),
  BioDataCube_DataInternal  NUMBER,
  BioDataCube_DataExternal  NUMBER,
  --
  CONSTRAINT PK_BioDataValues PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  DataFormat  VARCHAR2(255),
  DataFormatInfoURI  VARCHAR2(255),
  FilenameURI  VARCHAR2(255),
  --
  CONSTRAINT PK_DataExternal PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_DataInternal PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Value  VARCHAR2(255),
  --
  CONSTRAINT PK_Datum PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Name  VARCHAR2(255),
  --
  CONSTRAINT PK_DesignElementDimension PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_DesignElementMapping PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  BioAssayTuple  NUMBER,
  DesignElement  NUMBER,
  --
  CONSTRAINT PK_DesignElementTuple PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Name  VARCHAR2(255),
  --
  CONSTRAINT PK_QuantitationTypeDimension PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  DataSetWID  NUMBER  NOT NULL,
  --
  CONSTRAINT PK_QuantitationTypeMapping PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  DesignElementTuple  NUMBER,
  QuantitationType  NUMBER,
  QuantitationTypeTuple_Datum  NUMBER,
  --
  CONSTRAINT PK_QuantitationTypeTuple PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Measurement  NUMBER,
  Treatment  NUMBER,
  BioAssayCreation  NUMBER,
  --
  CONSTRAINT PK_BioMaterialMeasurement PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  Compound_ComponentCompounds  NUMBER,
  Compound  NUMBER,
  Measurement  NUMBER,
  Treatment_CompoundMeasurements  NUMBER,
  --
  CONSTRAINT PK_CompoundMeasurement PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  DerivedBioAssay_Type  NUMBER,
  FeatureExtraction  NUMBER,
  BioAssayCreation  NUMBER,
  --
  CONSTRAINT PK_BioAssay PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Name  VARCHAR2(255),
  --
  CONSTRAINT PK_Channel PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  PhysicalBioAssay  NUMBER,
  --
  CONSTRAINT PK_Image PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  ClusterBioAssayData  NUMBER,
  --
  CONSTRAINT PK_BioAssayDataCluster PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  BioAssayDataCluster_Nodes  NUMBER,
  Node_Nodes  NUMBER,
  --
  CONSTRAINT PK_Node PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  Node_NodeContents  NUMBER,
  BioAssayDimension  NUMBER,
  DesignElementDimension  NUMBER,
  QuantitationDimension  NUMBER,
  --
  CONSTRAINT PK_NodeContents PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  WID  NUMBER  NOT NULL,
  DataSetWID  NUMBER  NOT NULL,
  Node_NodeValue  NUMBER,
  Name  VARCHAR2(255),
  Value  VARCHAR2(255),
  NodeValue_Type  NUMBER,
  NodeValue_Scale  NUMBER,
  NodeValue_DataType  NUMBER,
  --
  CONSTRAINT PK_NodeValue PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Value  VARCHAR2(255),
  KindCV  VARCHAR2(25),
  OtherKind  VARCHAR2(255),
  Measurement_Unit  NUMBER,
  --
  CONSTRAINT PK_Measurement PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  UnitNameCV  VARCHAR2(25),
  UnitNameCV2  VARCHAR2(25),
  UnitNameCV3  VARCHAR2(25),
  UnitNameCV4  VARCHAR2(25),
  UnitNameCV5  VARCHAR2(25),
  UnitNameCV6  VARCHAR2(25),
  UnitNameCV7  VARCHAR2(25),
  --
  CONSTRAINT PK_Unit PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Identifier  VARCHAR2(255),
  Name  VARCHAR2(255),
  Parameter_DefaultValue  NUMBER,
  Parameter_DataType  NUMBER,
  Parameterizable_ParameterTypes  NUMBER,
  --
  CONSTRAINT PK_Parameter PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  ParameterizableApplication  NUMBER,
  --
  CONSTRAINT PK_ParameterValue PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  Hardware  NUMBER,
  --
  CONSTRAINT PK_Parameterizable PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ...
  MAGEClass  VARCHAR2(100)  NOT NULL,
  ArrayDesign  NUMBER,
  ArrayManufacture  NUMBER,
  BioEvent_ProtocolApplications  NUMBER,
  SerialNumber  VARCHAR2(255),
  Hardware  NUMBER,
  ActivityDate  VARCHAR2(255),
  ProtocolApplication  NUMBER,
  ProtocolApplication2  NUMBER,
  Protocol  NUMBER,
  Version  VARCHAR2(255),
  ReleaseDate  DATE,
  Software  NUMBER,
  --
  CONSTRAINT PK_ParameterizableApplication PRIMARY KEY (WID) USING INDEX TABLESPACE INDEXES
);
...
(
  ArrayDesignWID  NUMBER  NOT NULL,
  ReporterGroupWID  NUMBER  NOT NULL
  --
);
...
(
  ArrayDesignWID  NUMBER  NOT NULL,
  CompositeGroupWID  NUMBER  NOT NULL
  --
);
...
(
  CompositeGroupWID  NUMBER  NOT NULL,
  CompositeSequenceWID  NUMBER  NOT NULL
  --
);
...
(
  ExperimentWID  NUMBER  NOT NULL,
  BioAssayDataClusterWID  NUMBER  NOT NULL
  --
);
...
(
  ExperimentWID  NUMBER  NOT NULL,
  BioAssayDataWID  NUMBER  NOT NULL
  --
);
...
(
  ExperimentDesignWID  NUMBER  NOT NULL,
  BioAssayWID  NUMBER  NOT NULL
  --
);
...
(
  QuantitationTypeWID  NUMBER  NOT NULL,
  ConfidenceIndicatorWID  NUMBER  NOT NULL
  --
);
...
(
  QuantitationTypeWID  NUMBER  NOT NULL,
  QuantitationTypeMapWID  NUMBER  NOT NULL
  --
);
...
(
  ArrayGroupWID  NUMBER  NOT NULL,
  ArrayWID  NUMBER  NOT NULL
  --
);
...
(
  ArrayManufactureWID  NUMBER  NOT NULL,
  ArrayWID  NUMBER  NOT NULL
  --
);
...
(
  CompositeSequenceWID  NUMBER  NOT NULL,
  BioSequenceWID  NUMBER  NOT NULL
  --
);
...
(
  CompositeSequenceWID  NUMBER  NOT NULL,
  ReporterCompositeMapWID  NUMBER  NOT NULL
  --
);
...
(
  CompositeSequenceWID  NUMBER  NOT NULL,
  CompositeCompositeMapWID  NUMBER  NOT NULL
  --
);
...
(
  FeatureWID1  NUMBER  NOT NULL,
  FeatureWID2  NUMBER  NOT NULL
  --
);
...
(
  ReporterWID  NUMBER  NOT NULL,
  FeatureReporterMapWID  NUMBER  NOT NULL
  --
);
...
(
  BioAssayDimensionWID  NUMBER  NOT NULL,
  BioAssayWID  NUMBER  NOT NULL
  --
);
...
(
  BioAssayMapWID  NUMBER  NOT NULL,
  BioAssayWID  NUMBER  NOT NULL
  --
);
...
(
  BioAssayMappingWID  NUMBER  NOT NULL,
  BioAssayMapWID  NUMBER  NOT NULL
  --
);
...
(
  CompositeSequenceDimensionWID  NUMBER  NOT NULL,
  CompositeSequenceWID  NUMBER  NOT NULL
  --
);
...
(
  DesignElementMappingWID  NUMBER  NOT NULL,
  DesignElementMapWID  NUMBER  NOT NULL
  --
);
...
(
  FeatureDimensionWID  NUMBER  NOT NULL,
  FeatureWID  NUMBER  NOT NULL
  --
);
...
(
  QuantitationTypeDimensionWID  NUMBER  NOT NULL,
  QuantitationTypeWID  NUMBER  NOT NULL
  --
);
...
(
  QuantitationTypeMappingWID  NUMBER  NOT NULL,
  QuantitationTypeMapWID  NUMBER  NOT NULL
  --
);
...
(
  ReporterDimensionWID  NUMBER  NOT NULL,
  ReporterWID  NUMBER  NOT NULL
  --
);
...
(
  TransformationWID  NUMBER  NOT NULL,
  BioAssayDataWID  NUMBER  NOT NULL
  --
);
...
(
  LabeledExtractWID  NUMBER  NOT NULL,
  CompoundWID  NUMBER  NOT NULL
  --
);
...
(
  BioAssayWID  NUMBER  NOT NULL,
  FactorValueWID  NUMBER  NOT NULL
  --
);
...
(
  DerivedBioAssayWID  NUMBER  NOT NULL,
  DerivedBioAssayDataWID  NUMBER  NOT NULL
  --
);
...
(
  ImageAcquisitionWID  NUMBER  NOT NULL,
  ImageWID  NUMBER  NOT NULL
  --
);
...
(
  MeasuredBioAssayWID  NUMBER  NOT NULL,
  MeasuredBioAssayDataWID  NUMBER  NOT NULL
  --
);
...
(
  HardwareWID  NUMBER  NOT NULL,
  SoftwareWID  NUMBER  NOT NULL
  --
);
...
(
  ProtocolApplicationWID  NUMBER  NOT NULL,
  PersonWID  NUMBER  NOT NULL
  --
);
...
(
  SoftwareWID1  NUMBER  NOT NULL,
  SoftwareWID2  NUMBER  NOT NULL
  --
);
