...
#ifndef _WH_POSTGRES_H
#define _WH_POSTGRES_H 1
...
void
wh_postgres_insert_into_chemical(int compound_wid,
...
void
wh_postgres_into_reaction(int wid,
...
void
wh_postgres_insert_into_enzymatic_reaction(int enzrxn_wid,
					int reaction_wid,
					int protein_wid,
...
void
wh_postgres_insert_into_gene(int gene_wid,
			  char * common_name,
			  char * unique_id,
			  char direction,
